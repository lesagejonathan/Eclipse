...
class LinearCapture:
    ...
    def __init__(self, fs, scans, p, N, probedelays=None, WedgeParameters=None):
        ...
        self.GetDelays = {}
        self.GetDelays['DirectDirect'] = lambda c, offset: (self.GetWedgeDelays(c[0],offset[0], key='send'),self.GetWedgeDelays(c[1],offset[1], key='rec'))
    ...
    def GetWedgeBackWallDelays(self, c, Offset, Th, key):
    ...
    def ApplyTFM(self, ScanIndex, Elements=None, FilterParams=None, Normalize=False):
